                    ...
                    >
                        <p className="text-6xl font-playfair z-10 text-center md:text-start">
                            ...
                            <span
                                ...
                                xs:before:content-brush before:scale-75 before:absolute before:-left-[81px]
                        ...
                        <p className="mt-10 mb-7 text-sm text-center md:text-start">
                            asknknaskjnaskjfnas,n askdnasdnaskas,akjnanfaskfas
                            afjkfnaskfnasnasflkasnkannalnalfnasasnnalnfalnllnl.
                        </p>
                    </motion.div>
